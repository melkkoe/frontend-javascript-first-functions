...
function minutesToSeconds(a){
  return a * 60
}

const convertNumber = minutesToSeconds(1);

/*const convertNumber = minutesToSeconds(3);
const convertNumber = minutesToSeconds(23);*/
...
/*const wrappedWord = wrapper('beep', '_');*/
